...
const HeroContent = () => {
  return (
    <motion.div
      initial='hidden'
      animate='visible'
      className={`flex flex-row items-center justify-center px-20 mt-40 w-full z-[20] ${classes.heroContainer}`}
    >
      ...
      <motion.div
        ...
        className={`w-full h-full flex justify-center items-center ${classes.image} `}
      >
        <Image
